...
const cliConfig = {
  ...baseConfig,
  banner: {
    js: `const require = (await import('module')).createRequire(import.meta.url); globalThis.__filename = (await import('url')).fileURLToPath(import.meta.url); globalThis.__dirname = (await import('path')).dirname(globalThis.__filename);`,
  },
